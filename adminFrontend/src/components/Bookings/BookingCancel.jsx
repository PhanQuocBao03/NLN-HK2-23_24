...
const BookingConfirm = ({ open, handleClose, bookingId }) => {
  ...
  const updateIsApproved = async (e) => {
    ...
    try {
      ...
      const updatedBookingData = { ...bookingData, isApproved: 'cancel' };
      ...
      <form onSubmit={updateIsApproved}>
        ...
        <DialogBody className="p-4">
          ...
          {bookingData && bookingData.user && (
            <div>
                <p>
                Bạn có chắc muốn hủy lịch hẹn của khác hàng {" "}
        ...
        <DialogFooter className="bg-gray-100 justify-end">
          ...
          <div className="mt-7">
            <Button
              ...
              color="red"
              onClick={handleClose}
              className="text-white bg-green-600 text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg"
            >
              Đóng
            </Button>
          </div>
